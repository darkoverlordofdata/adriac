...
#ifndef __GLIB_SLIST_H__
#define __GLIB_SLIST_H__
...
static GSList*  g_slist_alloc                   (void);
static void     g_slist_free                    (GSList           *list);
static void     g_slist_free_1                  (GSList           *list);
#define	 g_slist_free1		         g_slist_free_1
static void     g_slist_free_full               (GSList           *list,
					  GDestroyNotify    free_func);
static GSList*  g_slist_append                  (GSList           *list,
					  gpointer          data);
static GSList*  g_slist_prepend                 (GSList           *list,
					  gpointer          data);
static GSList*  g_slist_insert                  (GSList           *list,
					  gpointer          data,
					  gint              position);
static GSList*  g_slist_insert_sorted           (GSList           *list,
					  gpointer          data,
					  GCompareFunc      func);
static GSList*  g_slist_insert_sorted_with_data (GSList           *list,
					  gpointer          data,
					  GCompareDataFunc  func,
					  gpointer          user_data);
static GSList*  g_slist_insert_before           (GSList           *slist,
					  GSList           *sibling,
					  gpointer          data);
static GSList*  g_slist_concat                  (GSList           *list1,
					  GSList           *list2);
static GSList*  g_slist_remove                  (GSList           *list,
					  gconstpointer     data);
static GSList*  g_slist_remove_all              (GSList           *list,
					  gconstpointer     data);
static GSList*  g_slist_remove_link             (GSList           *list,
					  GSList           *link_);
static GSList*  g_slist_delete_link             (GSList           *list,
					  GSList           *link_);
static GSList*  g_slist_reverse                 (GSList           *list);
static GSList*  g_slist_copy                    (GSList           *list);

static GSList*  g_slist_copy_deep               (GSList            *list,
					  GCopyFunc         func,
					  gpointer          user_data);
static GSList*  g_slist_nth                     (GSList           *list,
					  guint             n);
static GSList*  g_slist_find                    (GSList           *list,
					  gconstpointer     data);
static GSList*  g_slist_find_custom             (GSList           *list,
					  gconstpointer     data,
					  GCompareFunc      func);
static gint     g_slist_position                (GSList           *list,
					  GSList           *llink);
static gint     g_slist_index                   (GSList           *list,
					  gconstpointer     data);
static GSList*  g_slist_last                    (GSList           *list);
static guint    g_slist_length                  (GSList           *list);
static void     g_slist_foreach                 (GSList           *list,
					  GFunc             func,
					  gpointer          user_data);
static GSList*  g_slist_sort                    (GSList           *list,
					  GCompareFunc      compare_func);
static GSList*  g_slist_sort_with_data          (GSList           *list,
					  GCompareDataFunc  compare_func,
					  gpointer          user_data);
static gpointer g_slist_nth_data                (GSList           *list,
					  guint             n);
