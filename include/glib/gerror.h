...
#ifndef __GLIB_ERROR_H__
#define __GLIB_ERROR_H__
...
static GError*  g_error_new           (GQuark         domain,
                                gint           code,
                                const gchar   *format,
                                ...) G_GNUC_PRINTF (3, 4);


static GError*  g_error_new_literal   (GQuark         domain,
                                gint           code,
                                const gchar   *message);

static GError*  g_error_new_valist    (GQuark         domain,
                                gint           code,
                                const gchar   *format,
...
static GError*  g_error_copy          (const GError  *error);


static gboolean g_error_matches       (const GError  *error,
                                GQuark         domain,
                                gint           code);
...
static void     g_set_error           (GError       **err,
                                GQuark         domain,
                                gint           code,
                                const gchar   *format,
                                ...) G_GNUC_PRINTF (4, 5);
...
static void     g_propagate_error     (GError       **dest,
				GError        *src);
...
static void     g_prefix_error               (GError       **err,
                                       const gchar   *format,
                                       ...) G_GNUC_PRINTF (2, 3);

/* g_propagate_error then g_error_prefix on dest */

static void     g_propagate_prefixed_error   (GError       **dest,
                                       GError        *src,
                                       const gchar   *format,
                                       ...) G_GNUC_PRINTF (3, 4);
