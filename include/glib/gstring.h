...
#ifndef __GLIB_STRING_H__
#define __GLIB_STRING_H__
...
static GString*     g_string_new_len           (const gchar     *init,
                                         gssize           len);

static GString*     g_string_sized_new         (gsize            dfl_size);

static gchar*       g_string_free              (GString         *string,
                                         gboolean         free_segment);
static GBytes*      g_string_free_to_bytes     (GString         *string);

static gboolean     g_string_equal             (const GString   *v,
                                         const GString   *v2);

static guint        g_string_hash              (const GString   *str);

static GString*     g_string_assign            (GString         *string,
                                         const gchar     *rval);

static GString*     g_string_truncate          (GString         *string,
                                         gsize            len);

static GString*     g_string_set_size          (GString         *string,
                                         gsize            len);

static GString*     g_string_insert_len        (GString         *string,
                                         gssize           pos,
                                         const gchar     *val,
                                         gssize           len);

static GString*     g_string_append            (GString         *string,
                                         const gchar     *val);

static GString*     g_string_append_len        (GString         *string,
                                         const gchar     *val,
                                         gssize           len);

static GString*     g_string_append_c          (GString         *string,
                                         gchar            c);

static GString*     g_string_append_unichar    (GString         *string,
                                         gunichar         wc);

static GString*     g_string_prepend           (GString         *string,
                                         const gchar     *val);

static GString*     g_string_prepend_c         (GString         *string,
                                         gchar            c);

static GString*     g_string_prepend_unichar   (GString         *string,
                                         gunichar         wc);

static GString*     g_string_prepend_len       (GString         *string,
                                         const gchar     *val,
                                         gssize           len);

static GString*     g_string_insert            (GString         *string,
                                         gssize           pos,
                                         const gchar     *val);

static GString*     g_string_insert_c          (GString         *string,
                                         gssize           pos,
                                         gchar            c);

static GString*     g_string_insert_unichar    (GString         *string,
                                         gssize           pos,
                                         gunichar         wc);

static GString*     g_string_overwrite         (GString         *string,
                                         gsize            pos,
                                         const gchar     *val);

static GString*     g_string_overwrite_len     (GString         *string,
                                         gsize            pos,
                                         const gchar     *val,
                                         gssize           len);

static GString*     g_string_erase             (GString         *string,
                                         gssize           pos,
                                         gssize           len);

static GString*     g_string_ascii_down        (GString         *string);

static GString*     g_string_ascii_up          (GString         *string);

static void         g_string_vprintf           (GString         *string,
                                         const gchar     *format,
                                         va_list          args)
                                         G_GNUC_PRINTF(2, 0);

static void         g_string_printf            (GString         *string,
                                         const gchar     *format,
                                         ...) G_GNUC_PRINTF (2, 3);

static void         g_string_append_vprintf    (GString         *string,
                                         const gchar     *format,
                                         va_list          args)
                                         G_GNUC_PRINTF(2, 0);

static void         g_string_append_printf     (GString         *string,
                                         const gchar     *format,
                                         ...) G_GNUC_PRINTF (2, 3);

// static GString*     g_string_append_uri_escaped (GString         *string,
...
// GLIB_DEPRECATED
static GString *g_string_down (GString *string);
// GLIB_DEPRECATED
static GString *g_string_up   (GString *string);
