...
namespace GLib {
	...
	public abstract class InputStream : GLib.Object {
		...
		public bool has_pending ();
		public bool is_closed ();
		[CCode (vfunc_name = "read_fn", cname = "g_input_stream_read")]
	...
	[CCode (cname = "g_resources_lookup_data", cheader_filename = "gio/gio.h")]
	public static GLib.Bytes ResourcesLookupData (string path, GLib.ResourceLookupFlags lookup_flags) throws GLib.Error;
	[CCode (cname = "g_resources_open_stream", cheader_filename = "gio/gio.h")]
	public static GLib.InputStream ResourcesOpenStream (string path, GLib.ResourceLookupFlags lookup_flags) throws GLib.Error;
	[CCode (cheader_filename = "gio/gio.h")]
