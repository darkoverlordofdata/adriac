...
static void     g_list_free_1                  (GList            *list);
#define  g_list_free1                   g_list_free_1
static void     g_list_free_full               (GList            *list,
					 GDestroyNotify    free_func);
static GList*   g_list_append                  (GList            *list,
					 gpointer          data);
static GList*   g_list_prepend                 (GList            *list,
					 gpointer          data);
static GList*   g_list_insert                  (GList            *list,
					 gpointer          data,
					 gint              position);
static GList*   g_list_insert_sorted           (GList            *list,
					 gpointer          data,
					 GCompareFunc      func);
static GList*   g_list_insert_sorted_with_data (GList            *list,
					 gpointer          data,
					 GCompareDataFunc  func,
					 gpointer          user_data);
static GList*   g_list_insert_before           (GList            *list,
					 GList            *sibling,
					 gpointer          data);
static GList*   g_list_concat                  (GList            *list1,
					 GList            *list2);
static GList*   g_list_remove                  (GList            *list,
					 gconstpointer     data);
static GList*   g_list_remove_all              (GList            *list,
					 gconstpointer     data);
static GList*   g_list_remove_link             (GList            *list,
					 GList            *llink);
static GList*   g_list_delete_link             (GList            *list,
					 GList            *link_);
static GList*   g_list_reverse                 (GList            *list);
static GList*   g_list_copy                    (GList            *list);
static GList*   g_list_copy_deep               (GList            *list,
					 GCopyFunc         func,
					 gpointer          user_data);
static GList*   g_list_nth                     (GList            *list,
					 guint             n);
static GList*   g_list_nth_prev                (GList            *list,
					 guint             n);
static GList*   g_list_find                    (GList            *list,
					 gconstpointer     data);
static GList*   g_list_find_custom             (GList            *list,
					 gconstpointer     data,
					 GCompareFunc      func);
static gint     g_list_position                (GList            *list,
					 GList            *llink);
static gint     g_list_index                   (GList            *list,
					 gconstpointer     data);
static GList*   g_list_last                    (GList            *list);
static GList*   g_list_first                   (GList            *list);
static guint    g_list_length                  (GList            *list);
static void     g_list_foreach                 (GList            *list,
					 GFunc             func,
					 gpointer          user_data);
static GList*   g_list_sort                    (GList            *list,
					 GCompareFunc      compare_func);
static GList*   g_list_sort_with_data          (GList            *list,
					 GCompareDataFunc  compare_func,
					 gpointer          user_data) ;
static gpointer g_list_nth_data                (GList            *list,
					 guint             n);
